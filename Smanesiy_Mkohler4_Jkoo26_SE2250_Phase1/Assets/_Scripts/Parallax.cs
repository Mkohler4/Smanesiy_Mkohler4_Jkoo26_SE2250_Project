...
public class Parallax : MonoBehaviour
{
    ...
    private float _panelHeight; //Height of each panel
    ...
    {
        float tY, tX = 0;
        tY = Time.time * scrollSpeed % _panelHeight + (_panelHeight * 0.5f);
        ...
        if(tY >= 0)
        {
            panels[1].transform.position = new Vector3(tX, tY - _panelHeight, _depth);
